...
public class wallRun_josh : MonoBehaviour, IDamage
{
    ...
    void Start()
    {
        ...
        //originalModelRotation = playerModel.localRotation;
    }
    ...
    void Update()
    {
        ...
        //Camera.main.GetComponent<cameraController>().HandleCameraRotation();
